        ...
        <div className='grid lg:grid-cols-2  grid-cols-1 gap-5  '>
          ...
          <div className='bg-white lg:w-[500px] w-full mx-auto h-auto py-14'>
             ...
             <div className='grid lg:grid-cols-2 md:grid-cols-2 grid-cols-1  gap-5'>
              ...
              <textarea name="" id="" placeholder='Type Your Message' className='border border-[#D8D8D8] rounded-2xl px-5 py-3 outline-none lg:w-96 w-full'></textarea>
               </div>
             </div>
              <div className='px-6' >
                <Link href='/'>
                    <button className='bg-[#2563EB] w-full py-3 rounded-full text-white mt-5 '>Make an Appointment</button>
                </Link>
              </div>
          </div>
