...
function testimonials() {
  return (
    <div className='bg-[#0B577E] h-auto'>
       ...
       <div>
          <h2 className='text-4xl sm:text-5xl md:text-6xl lg:text-7xl  text-center font-semibold text-white'>
       ...
       <div className='grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-5 gap-10'>  
         <div className='bg-white rounded-tr-[10vh] rounded-bl-[10vh] rounded-md py-10'>
           <div className='px-10'>
           <h2 className='text-[24px] text-[#0E9CD9] py-3'>Exceptional Services.</h2>
           <p className='text-sm'>I must say that Dr. Darkhshan Nausheen is a combination of high technology and a very kind Religious personality. After joining his Rehab skill I had a click in my mind that now things will improve on my side. And it happened. My husband become better and one step ahead day by day. I saw whenever he's giving treatment he's also reciting the Quran. Thank you so much Doc for making Hamid, 's life better.</p>
           </div>
           <div className='flex px-12 py-4 gap-5 items-center'>
                <Image src="/images/aboutme.jpg" alt="Rehab Fit" width={450} height={650} className='w-10 h-10 rounded-full' />
                <div>
                  <h4 className='text-[#0E9CD9]'>Muhammad sara</h4>
         ...
         <div className='bg-white rounded-tr-[10vh] rounded-bl-[10vh] rounded-md py-10'>
           <div className='px-10'>
           <h2 className='text-[24px] text-[#0E9CD9] py-3'>Awesome Physiotherapist</h2>
         ...
         <div className='bg-white rounded-tr-[10vh] rounded-bl-[10vh] rounded-md py-10'>
           <div className='px-10'>
           <h2 className='text-[24px] text-[#0E9CD9] py-3'>Highly recommend!</h2>
           <p className='text-sm'>Excellent facility and staff. I have received Physiotherapy for my knee. The doctors are experts in the field and provide the best care possible. Highly recommend!</p>
           </div>
